...
FPS_UE420-Linux-Debug:
	 $(PROJECTBUILD) FPS_UE420 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420-Linux-DebugGame:
	 $(PROJECTBUILD) FPS_UE420 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420-Linux-Shipping:
	 $(PROJECTBUILD) FPS_UE420 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420-Linux-Test:
	 $(PROJECTBUILD) FPS_UE420 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420:
	 $(PROJECTBUILD) FPS_UE420 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420Editor-Linux-Debug:
	 $(PROJECTBUILD) FPS_UE420Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420Editor-Linux-DebugGame:
	 $(PROJECTBUILD) FPS_UE420Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420Editor-Linux-Shipping:
	 $(PROJECTBUILD) FPS_UE420Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420Editor-Linux-Test:
	 $(PROJECTBUILD) FPS_UE420Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPS_UE420Editor:
	 $(PROJECTBUILD) FPS_UE420Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
