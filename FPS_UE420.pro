...
unrealRootPath=/home/dannyliu/unreal420/UnrealEngine
FPS_UE420RootPath=/home/dannyliu/Documents/Unreal Projects/FPS_UE420

gameProjectFile=/home/dannyliu/Documents/Unreal Projects/FPS_UE420/FPS_UE420.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FPS_UE420Source.pri)
include(FPS_UE420Header.pri)
include(FPS_UE420Config.pri)
include(FPS_UE420Includes.pri)
include(FPS_UE420Defines.pri)
...
FPS_UE420-Linux-Debug.commands = $$build FPS_UE420 Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPS_UE420-Linux-DebugGame.commands = $$build FPS_UE420 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPS_UE420-Linux-Shipping.commands = $$build FPS_UE420 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPS_UE420-Linux-Test.commands = $$build FPS_UE420 Linux Test  -project="\"$$gameProjectFile\"" $$args
FPS_UE420.commands = $$build FPS_UE420 Linux Development  -project="\"$$gameProjectFile\"" $$args

FPS_UE420Editor-Linux-Debug.commands = $$build FPS_UE420Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FPS_UE420Editor-Linux-DebugGame.commands = $$build FPS_UE420Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FPS_UE420Editor-Linux-Shipping.commands = $$build FPS_UE420Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FPS_UE420Editor-Linux-Test.commands = $$build FPS_UE420Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
FPS_UE420Editor.commands = $$build FPS_UE420Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	FPS_UE420-Linux-Debug \
	FPS_UE420-Linux-DebugGame \
	FPS_UE420-Linux-Shipping \
	FPS_UE420-Linux-Test \
	FPS_UE420 \
	FPS_UE420Editor-Linux-Debug \
	FPS_UE420Editor-Linux-DebugGame \
	FPS_UE420Editor-Linux-Shipping \
	FPS_UE420Editor-Linux-Test \
	FPS_UE420Editor \
